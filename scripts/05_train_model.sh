...
# [A-2] ACT 이미지 증강 학습 (Augmentation) - 필요 시 주석 해제
# lerobot-train \
...
#   --batch_size=8 \
#   --steps=60000 \
#   --output_dir=outputs/train/bae/act_aug \
#   --policy.repo_id=local/act_candy_aug \
...
#     "brightness": {"type": "ColorJitter", "weight": 1.0, "kwargs": {"brightness": [0.85, 1.15]}},
#     "contrast": {"type": "ColorJitter", "weight": 1.0, "kwargs": {"contrast": [0.85, 1.15]}},
#     "sharpness": {"type": "SharpnessJitter", "weight": 0.5, "kwargs": {"sharpness": [0.5, 1.5]}}
#   }'
...
# [B-1] SmolVLA 기본 파인튜닝 (Standard) - 필요 시 주석 해제
# lerobot-train \
#   --dataset.repo_id=local/candy_data \
#   --dataset.root=data_bae/single_yellow \
#   --policy.type=smolvla \
...
# [B-2] SmolVLA 이미지 증강 파인튜닝 (Augmentation) - 필요 시 주석 해제
# lerobot-train \
#   --dataset.repo_id=bae/data_ball \
#   --dataset.root=data_ball/data30 \
#   --policy.type=smolvla \
#   --policy.pretrained_path=lerobot/smolvla_base \
#   --policy.device=cuda \
#   --batch_size=8 \
#   --steps=50000 \
#   --output_dir=outputs/train/ball/smolvla_tune \
#   --policy.repo_id=local/smolvla_ball \
#   --dataset.video_backend=pyav \
#   --dataset.image_transforms.enable=true \
#   --dataset.image_transforms.max_num_transforms=2 \
#   --dataset.image_transforms.random_order=true \
